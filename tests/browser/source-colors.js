;(async () => {
  ...
  const main = add('indoor_drawout_breaker', 'utility_breaker', -330, -70)
  const load = add('load', 'utility_load', -330, 160)
  const generator = add('generator', 'generator', 330, -240)
  const genBreaker = add('indoor_drawout_breaker', 'generator_breaker', 330, -70)
  const genLoad = add('load', 'generator_load', 330, 160)
  const spare = add('indoor_drawout_breaker', 'spare_breaker', 0, -70)
